package com.abdelrahman.blog.domain.aspect;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.abdelrahman.blog.domain..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.abdelrahman.blog.domain.*.*(..))",throwing = "ex")
